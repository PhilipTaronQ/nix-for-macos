...
/// §11.2 step 5: FileVault-encrypt the Nix volume, with the password in the
/// System keychain so the volume unlocks at boot ("hard-earned enterprise
/// ball knowledge" — decided IN, 2026-07-06).
///
