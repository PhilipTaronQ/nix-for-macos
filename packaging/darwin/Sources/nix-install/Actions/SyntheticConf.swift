...
/// §11.2 step 1: the `nix` line in /etc/synthetic.conf, which makes the
...
///
/// Wisdom inherited from the Rust installer (DESIGN.md §11.2):
...
///     a SEPARATE action (§11.2 step 2), so this one stays a pure file edit
