      ...
      */
      ...
      packages = forAllSystems (
        system:
        {
          ...
          # Source manifest for the macOS-standalone build: every external
          # dependency's src + version, resolved through the same
          # nixDependencies scope the flake build uses.
          standalone-sources = import ./packaging/standalone-sources.nix {
            inherit lib;
            pkgs = nixpkgsFor.${system}.native;
